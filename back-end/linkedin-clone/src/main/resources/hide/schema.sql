...
--
-- Table structure for table `post_users_interested`
--

DROP TABLE IF EXISTS `post_users_interested`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `post_users_interested` (
  ...
  KEY `FKt4r4rd9cc0nb85tg88ul1o37w` (`users_interested_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `user_posts_interested`
--

DROP TABLE IF EXISTS `user_posts_interested`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `user_posts_interested` (
  ...
  KEY `FKbqaqn4cboigrlnsecaem7oh4c` (`posts_interested_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `user_users_connected_with`
--

DROP TABLE IF EXISTS `user_users_connected_with`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `user_users_connected_with` (
  ...
  KEY `FKimidkhkps5ykn61o5ctxhausb` (`users_connected_with_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-09-05 19:54:41
